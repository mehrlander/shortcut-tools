...
| `stage-input` | Sends what was shared to the Web Tools stage in Safari. Text of 1 to 4,000 characters rides the link as `#take=`; anything else (an image, a file, a long page) goes to the clipboard and the app opens on the stage for one tap of Paste. With no input it stages the clipboard. 17 actions, in the share sheet. |
