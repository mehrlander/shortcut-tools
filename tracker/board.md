...
- 🎫 [Make apps and app return usable action names](tasks/land-grouped-action-taxonomy-r79gj3.md) (`claude/shortcut-tools-tracker-cpc8d7`)
- 🎫 [Validate that a generated shortcut imports on device](tasks/validate-builder-round-trip-zqposq.md) (`claude/shortcut-tools-review-etjnrv`)
